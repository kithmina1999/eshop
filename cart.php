                                        ...
                                        <div class="card mb-3 mx-0 col-12">
                                            <div class="row g-0">
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <span class="fw-bold text-black fs-5">Sahan Perera</span>&nbsp;
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    data-bs-content="Good production" title="Product Description">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black fs-5">Rs. 150000 .00</span>
                                                        <br>
                                                ...
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black-50">Rs.155000.00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <!-- <div class="col-12 col-lg-3">
                            <div class="row">
                                ...
                                <div class="col-6 text-end mb-3">
                                    <span class="fs-6 fw-bold">Rs. 155000 .00</span>
                                </div>
                                ...
                                <div class="col-6 mt-2 text-end">
                                    <span class="fs-4 fw-bold">Rs. 155250 .00</span>
                                </div>
